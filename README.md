...
- **A GitHub Action.** For agents that should exist for exactly one run: `uses: loopedautomation/agent-framework@v0.7.1` pipes a prompt into the agent in CI and hands the reply back as a step output. See [GitHub Actions](docs/github-actions.md).
