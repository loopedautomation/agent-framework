...
- [`rememberall-bot`](rememberall-bot/) - a Discord memory keeper: tell it things, ask for them back later, and have it remind you at a time you name. Persistent memory plus agent-created schedules, with a Coolify deployment path in the README.
