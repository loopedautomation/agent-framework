...
> **resend-bot:** Filed: CloudHost, $42.00, due 2026-08-01.
>
> **Amin:** what's due this month?
> **resend-bot:** CloudHost - $42.00 due 2026-08-01.
...
- Every filed invoice is a memory write in the [audit trail](../../docs/docker-run.md), and the `resend-bot-data` volume is where all of it lives. Deleting the volume deletes the ledger.
