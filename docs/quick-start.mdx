...
- Start from a complete, runnable agent: the [gh-issues-bot example](https://github.com/loopedautomation/agent-framework/tree/main/examples/gh-issues-bot) uses the same file shape, adds triggers, skills and permissions, and deploys with `docker compose up`
