...
The finished agent is in the repo as the [mail-assistant example](https://github.com/loopedautomation/agent-framework/tree/main/examples/mail-assistant), so you can read this page as the reasoning and that directory as the result.
...
Ready to build it? Start from the [example directory](https://github.com/loopedautomation/agent-framework/tree/main/examples/mail-assistant) - the README there walks through the Resend setup, the Gmail filters and the calendar URL step by step.
